...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # generating authors
        authors_list = ['Yakubu Ahmad', "Ibrahim Adamu", 'Anas Isah', 'Salisu Hamza']
        ...
        publishers_list = [
            ...
            {'name': 'Books', 'country': Country(code='de')},
        ...
        customers_list = [
            ...
            {'first_name': "Adam", 'last_name': 'Uthmaan'},
            {'first_name': "Is'haaq", 'last_name': "Daahir"},
        ]
