...
class Window(object):
    ...
    def update_command(self):
        database.update(selected_tuple[0], self.title_text.get(), self.author_text.get(), 
                        self.year_text.get(), self.isbn_text.get())
...
# Creating executable file with python
# Command: pyinstaller --onefile --windowed frontend.py
